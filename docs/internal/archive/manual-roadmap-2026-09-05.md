# Archived manual roadmap — 2026-09-05

Frozen from `docs/src/roadmap.md` at commit `ed4185fa84c5af163ee645ced9c338074635432b`.
This is a historical Documenter source snapshot, **not a current work order**.
Use the [active roadmap](../../../ROADMAP.md). The body is preserved apart from
rebased relative Markdown links; `@ref` entries retain their historical
Documenter notation. This file is outside the published manual source tree.
...
[MGMFRM Research Roadmap](../../src/mgmfrm-research-roadmap.md). The sequence records
...
[MGMFRM Research Roadmap](../../src/mgmfrm-research-roadmap.md).
...
[v0.1.1 Implementation Checklist](../../src/v0.1.1-implementation-checklist.md).
...
the [model-equations page](../../src/model-equations.md) for the DOI-backed source list.
