# Archived roadmap — 2026-09-05

Frozen from `ROADMAP.md` at commit `ed4185fa84c5af163ee645ced9c338074635432b`.
This is historical evidence and deferred design rationale, **not a current
work order or authorization**. Use the [active roadmap](../../../ROADMAP.md)
and [current anchor-study draft](../mfrm-anchor-study.md).
The body is preserved apart from rebased relative Markdown links. Commands and
inline repository paths still assume the repository root. Historical statuses,
percentages, and execution prerequisites below are not refreshed in place.
