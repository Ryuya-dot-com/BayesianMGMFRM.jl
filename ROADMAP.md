...
closed. The next gate is a runtime-only resource probe followed by grid/
resource freezing and independent threshold review, then the attempt-complete
executor. Evaluation uses untouched seeds.
