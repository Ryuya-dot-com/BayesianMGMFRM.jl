...
Short-NUTS execution remains explicit and is blocked before generation when
its free-memory gate is not met. Process-lifetime maxRSS is recorded but is not
