...
and are blocked before generation when their available-memory gates are not
met. On macOS, the gate records raw free pages separately from its reclaimable-
page estimate and memory-pressure check; the isolated short-NUTS route checks
both parent and child processes. Reused-
