...
`MFRMPrior` or the explicit
[`Experimental.ExchangeablePrior(rater_kernel_sd=...)`](docs/src/experimental.md#exchangeable-rater-prior),
then `BayesianMGMFRM.plot_prior` and `BayesianMGMFRM.plot_predictive`
